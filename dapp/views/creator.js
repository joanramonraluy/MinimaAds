...
function renderCreator(root) {
  ...
  form.innerHTML = ''
    ...
    + '    </label>'
    + '  </div>'
    + '  <div style="margin-top:0.75rem;padding:0.75rem 1rem;border-left:3px solid var(--pico-primary);background-color:rgba(0,0,0,0.015);border-radius:0 var(--pico-border-radius) var(--pico-border-radius) 0;font-size:0.78rem;line-height:1.35;">'
