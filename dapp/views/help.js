...
function renderHelp(root) {
  ...
  cStepsList.innerHTML =
    ...
    '<li style="margin-bottom:.5rem;">A fee is automatically calculated and added to your total funding: <strong>3%</strong> to the MinimaAds Foundation and <strong>3%</strong> platform fee. Your final payment will be: budget × 1.06.</li>' +
