...
function renderHelp(root) {
  ...
  cStepsList.innerHTML =
    ...
    '<li style="margin-bottom:.5rem;">Two separate fees are automatically added to your total funding: <strong>3%</strong> goes to the MinimaAds Foundation, and <strong>3%</strong> is a platform fee. Your final payment will be: budget × 1.06.</li>' +
